...
import { HomepageData } from '../../apirequest/homepage';

interface OurcompanyProps {
  homepageData: HomepageData | null;
}

const Ourcompany = ({ homepageData }: OurcompanyProps) => {
  return (
        ...
        <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 transform hover:scale-[1.02] transition-transform bg-gradient-to-br from-white to-indigo-50">
            ...
            <div className="space-y-4 sm:space-y-6">
              {homepageData?.homeAboutuspara1 && (
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  {homepageData.homeAboutuspara1}
                </p>
              )}
              {homepageData?.homeAboutuspara2 && (
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  {homepageData.homeAboutuspara2}
                </p>
              )}
              {homepageData?.homeAboutuspara3 && (
                <p className="text-sm sm:text-base text-gray-600 leading-relaxed">
                  {homepageData.homeAboutuspara3}
                </p>
              )}
          ...
          <div className="bg-white rounded-lg shadow-lg p-6 sm:p-8 transform hover:scale-[1.02] transition-transform bg-gradient-to-br from-white to-indigo-50">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center sm:justify-start mb-6 sm:mb-8 gap-4">
              <div className="relative">
                ...
                <img
                  src={homepageData?.homepresidentImage || "https://res.cloudinary.com/dfhisjy9w/image/upload/v1730447036/Screenshot_20241017_174331_Gallery_i6wbxm.jpg"}
                  alt="NAPA President"
            ...
            <div className="relative mb-6 sm:mb-8">
              <p className="text-sm sm:text-base text-gray-600 leading-relaxed pl-2">
                {homepageData?.homepresidentpara || (
                  <>
