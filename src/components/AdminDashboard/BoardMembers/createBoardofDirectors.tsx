...
import { createBoardMemberData } from '../../../apirequest/boardMember';
...
const CreateBoardMember = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await createBoardMemberData(formDataToSend);
    ...
    <>
      ...
      <Modal open={open} onClose={handleClose}>
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-gray-900">Create Board Member</h2>
          <p className="text-gray-600 mt-1">Fill in the details below to create a new Board Member.</p>
