...
import { fetchChapterLeadsPagination } from "../../../apirequest/boardMember";
import CreateChapterLeads from "./createchapterleads";
...
const CreateChapterLeadsDashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        setLoading(true);
        const response = await fetchChapterLeadsPagination(page, limit);
...
export default CreateChapterLeadsDashboard;
