...
const CreateChapterLeads = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      alert('Chapter Leads created successfully!');
      handleClose();
    } catch (error) {
    ...
    <>
      ...
      <Modal open={open} onClose={handleClose}>
        <div className="space-y-6">
          <h2 className="text-2xl font-bold text-gray-900">Create Chapter Leads</h2>
          <p className="text-gray-600 mt-1">Fill in the details below to Create Chapter Lead.</p>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex justify-end space-x-4 pt-4">
              ...
              <Button type="submit">Create Chapter Lead</Button>
            </div>
          </form>
        </div>
      </Modal>
...
export default CreateChapterLeads
;
