        ...
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="px-6 sm:px-8 py-8">
            ...
            {!showForgot ? (
              ...
              >
                <div>
                  <label htmlFor="forgotEmail" className="block text-sm font-medium text-gray-700">Enter your email to reset password</label>
                  <input
                    id="forgotEmail"
                    name="forgotEmail"
                    type="email"
                ...
                {forgotStatus && <p className="text-green-600 mt-2">{forgotStatus}</p>}
              </form>
            )}
